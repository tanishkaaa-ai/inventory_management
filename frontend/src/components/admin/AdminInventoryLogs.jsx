...
const AdminInventoryLogs = () => {
  ...
  <button
    onClick={() => window.open('https://inventory-management-n2c8.onrender.com/product/log/export/pdf', '_blank')}
    className="bg-red-600 text-white px-4 py-2 rounded-xl hover:bg-red-700 transition-all text-sm font-medium"
  >
    Export PDF
  </button>
  <button
    onClick={() => window.open('https://inventory-management-n2c8.onrender.com/product/log/export/excel', '_blank')}
